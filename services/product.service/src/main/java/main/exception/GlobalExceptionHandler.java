...
public class GlobalExceptionHandler {
    ...
    @ResponseStatus(HttpStatus.NOT_FOUND)
    public ResponseEntity<ResourceError> handlePurchaseException(ProductPurchaseException ex) {
        var errorResponse = new ResourceError(HttpStatus.NOT_FOUND.value(), ex.getMessage(), System.currentTimeMillis());
        return new ResponseEntity<>(errorResponse, HttpStatus.NOT_FOUND);
    }
    ...
    public ResponseEntity<ResourceError> handleInventoryExcpetion(InsufficientInventoryException ex) {
